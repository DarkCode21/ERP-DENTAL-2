...
{
    // Guarda los valores originales del modelo
    protected $original = [];

    // Ejemplo de atributos (puedes usar tu $attributes ya existente)
    ...
    /**
     * Sincroniza los valores actuales como originales.
     * Llama a esto después de cargar o guardar el modelo.
     */
    ...
    /**
     * Devuelve los valores modificados respecto al original
     */
