...
class SalesLineHTML
{
    ...
    private static function cantidad(Translator $i18n, string $idlinea, SalesDocumentLine $line, SalesDocument $model, string $jsFunc): string
    {
        ...
        return '<div class="col-sm-2 col-lg-1 order-3">'
            ...
            . '" class="form-control text-lg-right doc-line-qty" onkeyup="return ' . $jsFunc . '(\'recalculate-line\', \'0\', event);" style="border:none; border-bottom:1px solid #1a97f5;" placeholder="Cantidad" />'
