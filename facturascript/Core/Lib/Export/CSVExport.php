...
class CSVExport extends ExportBase
{
    ...
    public function show(Response &$response)
    {
        ...
        // BOM UTF-8: necesario para que Excel reconozca correctamente la codificación y muestre tildes y ñ sin problemas
        $response->setContent("\xEF\xBB\xBF" . $this->getDoc());
    }
