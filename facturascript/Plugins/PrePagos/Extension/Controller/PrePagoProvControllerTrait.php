 ...
 */
trait PrePagoProvControllerTrait
{
    public function createViews(): Closure
    {
        return function () {
            // añadimos la pestaña de pagos
            $viewName = 'EditPrePagoProv';
            $this->addEditListView($viewName, 'PrePagoProv', 'payments', 'fa-solid fa-coins')
    ...
    public function loadData(): Closure
    {
        return function ($viewName, $view) {
            ...
            $view->model->codproveedor = $model->codproveedor;
