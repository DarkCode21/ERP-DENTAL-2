...
/**
 * Trait that adds hasColumn() support to any ModelClass-based model.
 * Uses the existing getModelFields() method, which is already public.
 */
trait HasColumnTrait
{
    public function hasColumn(string $columnName): bool
    {
        return isset($this->getModelFields()[$columnName]);
    }
}
