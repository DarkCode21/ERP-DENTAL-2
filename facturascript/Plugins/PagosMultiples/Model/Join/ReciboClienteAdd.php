 ...
 */
class ReciboClienteAdd extends JoinModel
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setMasterModel(new ReciboCliente());
    }
    ...
    {
        return 'recibospagoscli recibos'
            . ' INNER JOIN facturascli facturas ON facturas.idfactura = recibos.idfactura'
            . ' INNER JOIN clientes subject ON subject.codcliente = recibos.codcliente';
    }
