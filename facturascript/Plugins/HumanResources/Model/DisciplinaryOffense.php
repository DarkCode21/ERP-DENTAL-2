...
/**
 * List of Disciplinary Offense Concepts
 *
 * @author Jose Antonio Cuello Principal <yopli2000@gmail.com>
 */
class DisciplinaryOffense extends ModelExtended
{

    use ModelTrait;

    /** Description of DisciplinaryOffense
     *
     * @var string
     */
    public $name;
    ...
    {
        return 'rrhh_disciplinaryoffenses';
    }
