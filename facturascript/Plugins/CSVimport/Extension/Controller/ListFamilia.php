...
class ListFamilia
{
    ...
    public function importFamiliesAction(): Closure
    {
        return function () {
            ...
            if ($template === CsvFileTools::AUTOMATIC && $this->importFamiliesAutoAction($filePath)) {
                return true;
            }
            ...
            $templateModel = $template === CsvFileTools::AUTOMATIC ?
                ...
                CsvFileTools::getFileTemplate($filePath, $template, 'families');
    ...
    public function importFamiliesAutoAction(): Closure
    {
        return function (string $filePath) {
            // buscamos una plantilla automática
            $autoTemplates = CSVfile::autoTemplate($filePath, 'families');
            ...
            $offset = (int)$this->request->get('import-offset', 0);
            $saveLines = (int)$this->request->get('save-lines', 0);
            if (false === $autoTemplates->run($filePath, 'families', $mode, $offset, $saveLines)) {
                return true;
            }
