 ...
 */
class OrdenIngrediente extends ModelClass
{
    use ModelTrait;
    ...
    /**
     * Lots already used in recursive calls to avoid using them.
     * Only for Trazabilidad plugin.
     * Needed for incompatibility with static properties into Extension FS system.
     *
     * @var array
     */
    public static array $lotsUsed = [];
    ...
    /**
     * Link to the lot used (Trazabilidad plugin).
     *
     * @var int|null
     */
    public $idlote;
    ...
    {
        return 'produccion_ordenesingredientes';
    }
