...
class EditArchivoFromPaciente extends PanelController
{
    public $files = [];
    public $specialists = [];
    public $appointments = [];
    ...
    {
        $this->addHtmlView('EditArchivoFromPaciente', 'Tab/ArchivoEditFromPaciente', 'Archivo', 'files', 'fas fa-paperclip');
    }
    ...
    protected function loadData($viewName, $view)
    {
        ...
        $this->idpaciente = $this->getViewModelValue($mainViewName, 'id');
    ...
    private function saveAction(): bool
    {
        ...
        $model->idpaciente = $this->idpaciente;
