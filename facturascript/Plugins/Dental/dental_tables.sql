...
CREATE TABLE dental_especialistas (
    ...
    salon_assistant_id INTEGER UNSIGNED,
    estado VARCHAR(20) DEFAULT 'activo',
    observaciones TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE dental_pacientes (
    ...
    salon_customer_id INTEGER UNSIGNED,
...
CREATE TABLE dental_tratamientos_paciente (
    ...
    salon_service_id INTEGER UNSIGNED,
...
CREATE TABLE dental_citas (
    ...
    salon_booking_id INTEGER UNSIGNED,
    salon_customer_id INTEGER UNSIGNED,
    salon_service_id INTEGER UNSIGNED,
    salon_sync_status VARCHAR(20),
    salon_sync_error TEXT,
    salon_synced_at TIMESTAMP NULL,
    fecha DATE NOT NULL,
