            ...
            switch ($type) {
                case 'public':
                    return empty($this->pc_uuid)
                        ? 'PortalPedido?code=' . $this->primaryColumnValue()
                        : 'PortalPedido/' . $this->pc_uuid;
                ...
                case 'public-print':
                    return empty($this->pc_uuid)
                        ? 'PortalPedido?code=' . $this->primaryColumnValue() . '&action=print'
                        : 'PortalPedido/' . $this->pc_uuid . '?action=print';
