            ...
            switch ($type) {
                case 'public':
                    return empty($this->pc_uuid)
                        ? 'PortalAlbaran?code=' . $this->primaryColumnValue()
                        : 'PortalAlbaran/' . $this->pc_uuid;
                ...
                case 'public-print':
                    return empty($this->pc_uuid)
                        ? 'PortalAlbaran?code=' . $this->primaryColumnValue() . '&action=print'
                        : 'PortalAlbaran/' . $this->pc_uuid . '?action=print';
